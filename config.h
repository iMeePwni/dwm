...
static const float facts[3]   = { 1.4,    1.4,    1.4 };    /* tiling facts */
...
/* commands */
static const char *alacrittycmd[]  = { "alacritty", "-e", "fish" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_n,      spawn,          {.v = alacrittycmd } },
	{ MODKEY,                       XK_w,      spawn,          {.v = upvol } },
	{ MODKEY,                       XK_e,      spawn,          {.v = downvol } },
	...
	{ MODKEY|ShiftMask,             XK_t,      setdirs,        {.v = (int[]){ DirRotHor, DirVer, DirVer } } },
